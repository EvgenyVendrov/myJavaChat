...
public class Client extends javax.swing.JFrame {
	...
	// shows every online members user name:

	private void showonline(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_SHOWONLINE
		client.allOnline(my_name.getText());
		jToggleButton_showOnline.setSelected(false);

	}// GEN-LAST:event_SHOWONLINE

	// connects the user to chats server:

	private void Connect(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_Connect
		client = new ClientCode(ip_ad.getText(), ServerCode.port, this.jTextArea_Main);
		client.connectMe(my_name.getText());
	...
	// sends a message to everyone whose online in the chat or to a certain user:

	private void Send(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_Send
		if (dst.getText().equals("NAME")) {
			client.sendPublicMessage(my_name.getText(), message_field.getText());
			message_field.setText("");
		} else {
			client.sendPrivateMessage(my_name.getText(), dst.getText(), message_field.getText());
			message_field.setText("");
		}
	...
	private void Disconnect(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_Disconnect
		client.disConnectMe(my_name.getText());
		jToggleButton_connect.setEnabled(true);
		jToggleButton_connect.setSelected(false);
		jButton_disconnect.setEnabled(false);
		jButton_disconnect.setSelected(false);
		jButton_send.setEnabled(false);
		message_field.setEditable(false);
